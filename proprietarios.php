...
if ($_SERVER['REQUEST_METHOD'] === 'POST' || $_SERVER['REQUEST_METHOD'] === 'PUT') {
    $proprietarios = $_POST['proprietarios'] ?? $_GET['proprietarios'];  // Recebe o nome da cidade
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $query = "INSERT INTO proprietarios (nome) VALUES ('$proprietarios')";
    } else {
        $id = $_GET['id'];
        $query = "UPDATE proprietarios SET nome = '$proprietarios' WHERE id = $id";
    }
