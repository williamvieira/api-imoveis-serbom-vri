...
if (isset($_GET['q']) && !empty($_GET['q'])) {
    ...
    $sql = "SELECT cod AS cod_matricula, apelido FROM imoveis WHERE LOWER(cod) LIKE '%$query%' OR apelido LIKE '%$query%'";
    ...
    $sql = "SELECT cod as cod_matricula, apelido FROM imoveis";
