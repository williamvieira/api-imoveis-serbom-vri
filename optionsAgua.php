...
if (isset($_GET['q']) && !empty($_GET['q'])) {
    ...
    $sql = "SELECT cod AS cod_matricula, apelido FROM aguas WHERE LOWER(cod) LIKE '%$query%' OR apelido LIKE '%$query%' LIMIT 10";
    ...
    $sql = "SELECT cod as cod_matricula, apelido FROM aguas LIMIT 10";
