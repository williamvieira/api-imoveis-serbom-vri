...
if ($_SERVER['REQUEST_METHOD'] === 'POST' || $_SERVER['REQUEST_METHOD'] === 'PUT') {
    $cidade = $_POST['cidade'] ?? $_GET['cidade'];  // Recebe o nome da cidade
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $query = "INSERT INTO local (nome) VALUES ('$cidade')";
    } else {
        $id = $_GET['id'];
        $query = "UPDATE local SET nome = '$cidade' WHERE id = $id";
    }
